...
### Machine (FAN-024)
Machine was banned and replaced by FAN-024 in the Frightful Foes set. From the rules insert in that set:

> Machine was one of the original Inventions in the Fantastic Battles Issue. Over time it has proven to be too powerful, so that version will be banned and replaced with the version found in this Issue.
...
### **Spider-Gwen MC**
- *Spider-Gwen's Level Up power "Multiverse Expert" should read "Level Up (4) - When a character appears on your side other than by being recruited **from your hand**, Ghost-Spider gains an XP."*

In an [official Facebook post](https://www.facebook.com/superawesomegamesllc/photos/a.738411749513686/5389838684370946) Super Awesome Games clarified that Spider-Gwen's Level Up power allows her to gain XP from other characters using her Dimensional Wristwatch and was always intended to work this way.
...
- *Additional side-deck clarifications*

There was a significant [rule update from August 2021](https://www.upperdeckblog.com/2021/08/vs-system-2pcg-rules-update-august-2021/) that included numerous clarifications regarding side-decks.
...
### Mantles can no longer cross intellectual properties

- *Cards with the "stars" in their name are mantles and cards sharing a name across multiple universes or IPs are no longer "sharing a mantle.*

This confusion was introduced in Legacy with the [\*Bishop\* card](http://vs.tcgbrowser.com/images/cards/big/LEG-015.jpg).  It shared a name with [Bishop from the Aliens set](http://vs.tcgbrowser.com/images/cards/big/ALN-016.jpg) and so it was given the star treatment to signify it is a separate character.  Ultimately as the game expanded and mechanics were introduced to leverage mantles, it did not make sense that these two cards would be "sharing a mantle" so in errata the stars will be removed from Legacy set Bishop.
